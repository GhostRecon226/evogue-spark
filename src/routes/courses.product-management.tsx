...
export const Route = createFileRoute("/courses/product-management")({
  ...
  component: () => (
    <CourseDetailTemplate
      ...
      faqs={[
        { q: "Do I need prior experience?", a: "Some experience working in a team or business context helps, but no formal product management background is required. Curiosity and a user-first mindset matter more." },
