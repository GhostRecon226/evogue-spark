...
export const Route = createFileRoute("/courses/project-management-business-analysis")({
  ...
  component: () => (
    <CourseDetailTemplate
      ...
      description="Our most comprehensive programme. Study both disciplines in depth over 6 weeks, then choose the career path that fits you best. Built for people who want to lead, not just participate."
      pills={{ weeks: "6 weeks", level: "Beginner – Intermediate" }}
