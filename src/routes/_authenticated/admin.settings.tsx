    ...
    <AdminGuard>
              ...
              {settings.logo_url ? (
                <div className="mt-1 relative rounded-2xl border-2 border-dashed border-border bg-mint-tint/30 p-4 flex items-center gap-4">
                  <img
                    ...
                    alt="Logo"
                    className="h-20 w-20 rounded-lg object-cover bg-background"
                  />
          ...
          <div className="mt-4 grid gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-foreground/55">
                Stored in the database. Production secrets should be set as environment variables.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-10 rounded-2xl border border-border bg-background p-5 shadow-soft">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-display text-lg font-extrabold text-forest">Admin accounts</h2>
        </div>
