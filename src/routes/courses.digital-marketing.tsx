  ...
  head: () => ({
    meta: [
      { title: "Digital Marketing — Evogue Academy" },
      {
        name: "description",
        content:
          "Run campaigns that convert. Paid ads, organic content, copywriting and analytics across every channel.",
      },
      { property: "og:title", content: "Digital Marketing — Evogue Academy" },
      {
        property: "og:description",
        content: "A 3-week live cohort that teaches modern digital marketing end-to-end.",
      },
    ...
    links: [
      { rel: "canonical", href: "https://evogue-spark.lovable.app/courses/digital-marketing" },
    ],
  }),
  component: () => (
      ...
      faqs={[
        {
          ...
          a: "None at all. This programme starts from the basics and builds up. If you've ever used social media or browsed the internet, you already have more context than you think.",
        },
        {
