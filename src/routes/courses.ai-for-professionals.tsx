...
export const Route = createFileRoute("/courses/ai-for-professionals")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Use AI tools to work smarter and automate repetitive tasks. No coding required.",
      },
      { property: "og:title", content: "AI for Professionals — Evogue Academy" },
      {
        property: "og:description",
        content: "Practical, non-technical AI skills you can apply from week one.",
      },
      { property: "og:type", content: "article" },
      {
        property: "og:url",
        content: "https://evogue-spark.lovable.app/courses/ai-for-professionals",
      },
    ...
    links: [
      { rel: "canonical", href: "https://evogue-spark.lovable.app/courses/ai-for-professionals" },
    ],
  }),
  component: () => (
      ...
      faqs={[
        {
          ...
          a: "Not at all. This programme is built specifically for non-technical professionals. If you can use a smartphone, you can do this course.",
        },
        {
