...
export const courses: Course[] = [
  {
    ...
    curriculum: [
      { week: "Week 1–2", title: "Design Foundations", topics: ["Design thinking", "User research basics", "Personas & journeys"] },
      { week: "Week 3–4", title: "Wireframing & IA", topics: ["Information architecture", "Low-fi wireframes", "User flows"] },
      { week: "Week 5–6", title: "Visual Design", topics: ["Typography", "Color theory", "Layout & spacing"] },
      { week: "Week 7–8", title: "Design Systems", topics: ["Tokens", "Components in Figma", "Documentation"] },
      { week: "Week 9–10", title: "Prototyping & Testing", topics: ["Interactive prototypes", "Usability testing", "Iteration"] },
      { week: "Week 11–12", title: "Portfolio & Career", topics: ["Case study writing", "Portfolio review", "Interview prep"] },
    ],
    instructor: {
      name: "Adaeze Okonkwo",
  ...
  },
  {
    ...
    longDescription: "Learn the craft of modern product management — discovery, prioritization, roadmapping, and shipping value continuously.",
    duration: "10 weeks",
    level: "Intermediate",
    price: "₦400,000",
    category: "Management",
    ...
    curriculum: [
      { week: "Week 1–2", title: "PM Fundamentals", topics: ["Role of PM", "Product lifecycle", "Stakeholder mapping"] },
      { week: "Week 3–4", title: "Discovery", topics: ["User interviews", "Jobs-to-be-done", "Opportunity solution trees"] },
      { week: "Week 5–6", title: "Strategy & Roadmap", topics: ["Vision", "OKRs", "Roadmapping"] },
      { week: "Week 7–8", title: "Execution", topics: ["Prioritization", "Sprint planning", "Metrics"] },
      { week: "Week 9–10", title: "Leadership", topics: ["Influence", "Storytelling", "Career growth"] },
    ],
    instructor: {
      name: "Tunde Bakare",
  ...
  },
  {
    ...
    longDescription: "From HTML/CSS fundamentals to production React apps with TypeScript, testing, and performance.",
    duration: "14 weeks",
    level: "Beginner – Intermediate",
    price: "₦500,000",
    ...
    active: false,
    whatYouLearn: ["HTML, CSS, JavaScript fundamentals", "Modern React with hooks", "TypeScript", "State management", "Testing", "Deployment & CI"],
    curriculum: [
      { week: "Week 1–3", title: "Web Foundations", topics: ["HTML semantics", "CSS layout", "JS essentials"] },
      { week: "Week 4–6", title: "React", topics: ["Components", "Hooks", "Routing"] },
      { week: "Week 7–9", title: "TypeScript & State", topics: ["Types", "Generics", "Zustand/Redux"] },
      { week: "Week 10–12", title: "Production", topics: ["Testing", "Performance", "Accessibility"] },
      { week: "Week 13–14", title: "Capstone", topics: ["Build & ship", "Code review", "Portfolio"] },
    ],
    instructor: {
      name: "Chinedu Okafor",
  ...
  },
  {
    ...
    active: false,
    whatYouLearn: ["REST & GraphQL APIs", "PostgreSQL & Redis", "Auth & security", "Background jobs", "Observability", "Cloud deploy"],
    curriculum: [
      { week: "Week 1–3", title: "Node Foundations", topics: ["JS runtime", "Express", "Middleware"] },
      ...
      { week: "Week 13–14", title: "Capstone", topics: ["Build & deploy", "Code review", "Portfolio"] },
    ],
    instructor: {
      name: "Funmi Adesanya",
  ...
  },
  {
    ...
    active: false,
    whatYouLearn: ["SQL fluency", "Python for analysis", "Statistical thinking", "Data visualization", "Dashboarding", "Storytelling with data"],
    curriculum: [
      { week: "Week 1–2", title: "Foundations", topics: ["Spreadsheets", "Stats basics", "Data types"] },
      ...
      { week: "Week 9–10", title: "Capstone", topics: ["Analysis project", "Presentation", "Portfolio"] },
    ],
    instructor: {
      name: "Kemi Lawal",
  ...
  },
  {
    ...
    longDescription: "Master the practical craft of running technology projects to successful delivery.",
    duration: "8 weeks",
    level: "Beginner – Intermediate",
    price: "₦300,000",
    category: "Management",
    ...
    active: false,
    whatYouLearn: ["Agile & Scrum", "Planning & estimation", "Risk management", "Stakeholder communication", "Tools (Jira, Linear)", "Reporting"],
    curriculum: [
      { week: "Week 1–2", title: "Foundations", topics: ["PM lifecycle", "Roles", "Methodologies"] },
  ...
  },
  {
    ...
    longDescription: "The new craft of working with LLMs — from prompt patterns to agent workflows.",
    duration: "6 weeks",
    level: "Beginner",
    price: "₦250,000",
    category: "Development",
    ...
    active: false,
    whatYouLearn: ["LLM fundamentals", "Prompt patterns", "Tool use & agents", "Evaluations", "RAG basics", "Productionizing AI features"],
    curriculum: [
      { week: "Week 1", title: "LLM Basics", topics: ["How LLMs work", "Tokens", "Models"] },
      { week: "Week 2–3", title: "Prompting", topics: ["Patterns", "Few-shot", "Chain of thought"] },
  ...
  },
  {
    ...
    longDescription: "End-to-end defensive security — networks, applications, identity, and incident response.",
    duration: "12 weeks",
    level: "Intermediate",
    price: "₦480,000",
    category: "Security",
    ...
    active: false,
    whatYouLearn: ["Network security", "Web app security", "Identity & access", "Cryptography basics", "Incident response", "Compliance"],
    curriculum: [
      { week: "Week 1–3", title: "Foundations", topics: ["Threat models", "Networking", "OS security"] },
  ...
  },
  {
    ...
    active: false,
    whatYouLearn: ["AWS core services", "Infrastructure as code", "CI/CD pipelines", "Containers & K8s", "Observability", "Cost & reliability"],
    curriculum: [
